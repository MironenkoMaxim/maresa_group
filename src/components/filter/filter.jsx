  ...
  <div className="filter filter__container">
   <ul className="filter__list">
    <li className="filter__item">
     ...
     <label for="filterAll" className="filter__label">Все</label>
    </li>
    <li className="filter__item">
     <input type="radio" id="filterMaresa" name="filter" className="filter__input" />
     <label for="filterMaresa" className="filter__label">Maresa Group</label>
    </li>
    <li className="filter__item">
     <input type="radio" id="filterTrend" name="filter" className="filter__input" />
     <label for="filterTrend" className="filter__label">Trend Toujour</label>
    </li>
   </ul>
   ...
   <ul className="sort">
    ...
    <li>
     ...
     <label for="sortUp" className="sort__label">
    ...
    <li>
     ...
     <label for="sortDown" className="sort__label">
      <svg width={16} height={14} aria-hidden="true">
